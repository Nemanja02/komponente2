<script>
    import {Label, Select, Table, TableHead, TableHeadCell, TableBody, TableBodyRow, TableBodyCell, Button, Checkbox, Modal, FloatingLabelInput, Toggle} from "flowbite-svelte";
    ...
    export const fetchData = () => {
        axios.get("http://localhost:8084/notifications/all", {
            headers: {
